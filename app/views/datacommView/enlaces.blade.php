   ...
   var category;
    ...
    $(function () {  
          ...
          $(".btn").on('click', function() {
              ...
              $.get( ip+"getdatosdatacomm2", { "anho_1": anho_1, "week_1": week_1, "anho_2": anho_2, "week_2": week_2 } ).done(function( data) {
                 ...
                 // ----------------------------------------------------------------//
                                                ...
                                                click: function (e) {
                                                    hs.htmlExpand(null, {
                                                        ...
                                                        maincontentText: 
                                                            ...
                                                            "<p> Serie "+ this.series.name + "</p> <p> Semana "+
                                                            this.category + "</p> <p>" +
                                                            Comentario5[this.series.name]['data'][this.x].replace(/\n/g,'<br>')+ "</p>",
                      ...
                      $('#grafica6').highcharts({
                                                ...
                                                click: function (e) {
                                                    hs.htmlExpand(null, {
                                                        ...
                                                        maincontentText: 
                                                            ...
                                                            "<p> Serie "+ this.series.name + "</p> <p> Semana "+
                                                            this.category + "</p> <p>" +
                                                            Comentario6[this.series.name]['data'][this.x].replace(/\n/g,'<br>')+ "</p>",
                                                ...
                                                click: function (e) {
                                                    hs.htmlExpand(null, {
                                                        ...
                                                        maincontentText: 
                                                            ...
                                                            "<p> Serie "+ this.series.name + "</p> <p> Semana "+
                                                            this.category + "</p> <p>" +
                                                            Comentario7[this.series.name]['data'][this.x].replace(/\n/g,'<br>')+ "</p>",
                         ...
                         $("#btn1").empty();
                        $("#btn1").append("<button onclick='abrirVentana(4,76,category)' >Actualizar </button>");    

                        $("#btn2").empty();
                        $("#btn2").append("<button onclick='abrirVentana(4,77,category)' >Actualizar </button>");

                        $("#btn3").empty();
                        $("#btn3").append("<button onclick='abrirVentana(4,78,category)' >Actualizar </button>");

                        $("#btn4").empty();
                        $("#btn4").append("<button onclick='abrirVentana(4,79,category)' >Actualizar </button>");


                        $("#btn5").empty();
                        $("#btn5").append("<button onclick='abrirVentana(4,80,category)' >Actualizar </button>");

                        $("#btn6").empty();
                        $("#btn6").append("<button onclick='abrirVentana(4,81,category)' >Actualizar </button>");

                        $("#btn7").empty();
                        $("#btn7").append("<button onclick='abrirVentana(4,192,category)' >Actualizar </button>");
...
<!-- ////////////////////////// Select de año y semanas ////////////////////////////////////////-->
      ...
      <section class="wrapper">
          ...
          <section id="main-content">
               ...
               <section class="wrapper">
                <h3 > Cockpit Datacomm - Enlaces</h3>
                <p></p>
