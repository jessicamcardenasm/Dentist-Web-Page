   ...
   var category;
        ...
        $(function () {  
          ...
          $(".btn").on('click', function() {
              ...
              $.get( ip+"getdatosdatacomm1", { "anho_1": anho_1, "week_1": week_1, "anho_2": anho_2, "week_2": week_2 } ).done(function( data) {
                      ...
                      $('#grafica6').highcharts({
                         ...
                         $("#btn1").empty();
                        $("#btn1").append("<button onclick='abrirVentana(4,70,category)' >Actualizar </button>");    

                        $("#btn2").empty();
                        $("#btn2").append("<button onclick='abrirVentana(4,71,category)' >Actualizar</button>");

                        $("#btn3").empty();
                        $("#btn3").append("<button onclick='abrirVentana(4,72,category)' >Actualizar </button>");

                        $("#btn4").empty();
                        $("#btn4").append("<button onclick='abrirVentana(4,73,category)' >Actualizar </button>");


                        $("#btn5").empty();
                        $("#btn5").append("<button onclick='abrirVentana(4,74,category)' >Actualizar </button>");

                        $("#btn6").empty();
                        $("#btn6").append("<button onclick='abrirVentana(4,75,category)' >Actualizar </button>");
...
<!-- ////////////////////////// Select de año y semanas ////////////////////////////////////////-->
      ...
      <section class="wrapper">
          ...
          <section id="main-content">
               ...
               <section class="wrapper">
                <h3 > Cockpit Datacomm - Equipos</h3>
                <p></p>
