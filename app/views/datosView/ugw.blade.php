   ...
   var category;
        ...
        $(function () {  
          ...
          $(".btn").on('click', function() {
              ...
              $.get( ip+"getdatosdatos2", { "anho_1": anho_1, "week_1": week_1, "anho_2": anho_2, "week_2": week_2 } ).done(function( data) {
                      ...
                      $('#grafica4').highcharts({
                         ...
                         $("#btn1").empty();
                        $("#btn1").append("<button onclick='abrirVentana(3,65, category)' >Actualizar </button>");    

                        $("#btn2").empty();
                        $("#btn2").append("<button onclick='abrirVentana(3,66, category)' >Actualizar </button>");

                        $("#btn3").empty();
                        $("#btn3").append("<button onclick='abrirVentana(3,67, category)' >Actualizar </button>");

                        $("#btn4").empty();
                        $("#btn4").append("<button onclick='abrirVentana(3,68, category)' >Actualizar </button>");
