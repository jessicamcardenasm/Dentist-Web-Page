   ...
   var category;
        ...
        $(function () {  
          ...
          $(".btn").on('click', function() {
              ...
              $.get( ip+"getdatosisp1", { "anho_1": anho_1, "week_1": week_1, "anho_2": anho_2, "week_2": week_2 } ).done(function( data) {
                      ...
                      $('#grafica6').highcharts({
                        ...
                        $("#btn1").empty();
                        $("#btn1").append("<button onclick='abrirVentana(8,161,category)' >Actualizar </button>");    

                        $("#btn2").empty();
                        $("#btn2").append("<button onclick='abrirVentana(8,162,category)' >Actualizar </button>");

                        $("#btn3").empty();
                        $("#btn3").append("<button onclick='abrirVentana(8,163,category)' >Actualizar </button>");

                        $("#btn4").empty();
                        $("#btn4").append("<button onclick='abrirVentana(8,164,category)' >Actualizar </button>");


                        $("#btn5").empty();
                        $("#btn5").append("<button onclick='abrirVentana(8,165,category)' >Actualizar </button>");

                        $("#btn6").empty();
                        $("#btn6").append("<button onclick='abrirVentana(8,166,category)' >Actualizar </button>");
...
<!-- ////////////////////////// Select de año y semanas ////////////////////////////////////////-->
      ...
      <section class="wrapper">
          ...
          <section id="main-content">
               ...
               <section class="wrapper">
                <h3 > Cockpit ISP Provider / IGR / ACS / EGR</h3>
                <p></p>
