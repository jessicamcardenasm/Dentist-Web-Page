   ...
   var category;
        ...
        $(function () {  
          ...
          $(".btn").on('click', function() {
              ...
              $.get( ip+"getdatosisp5", { "anho_1": anho_1, "week_1": week_1, "anho_2": anho_2, "week_2": week_2 } ).done(function( data) {
                      ...
                      $('#grafica5').highcharts({
                        ...
                        $("#btn1").empty();
                        $("#btn1").append("<button onclick='abrirVentana(8,181,category)' >Actualizar </button>");    

                        $("#btn2").empty();
                        $("#btn2").append("<button onclick='abrirVentana(8,182,category)' >Actualizar </button>");

                        $("#btn3").empty();
                        $("#btn3").append("<button onclick='abrirVentana(8,188,category)' >Actualizar </button>");

                        $("#btn4").empty();
                        $("#btn4").append("<button onclick='abrirVentana(8,189,category)' >Actualizar </button>");


                        $("#btn5").empty();
                        $("#btn5").append("<button onclick='abrirVentana(8,190,category)' >Actualizar </button>");
...
<!-- ////////////////////////// Select de año y semanas ////////////////////////////////////////-->
      ...
      <section class="wrapper">
          ...
          <section id="main-content">
               ...
               <section class="wrapper">
                <h3 > Cockpit ISP - Barracuda/CITRIX/RADWARE/Central LAN</h3>
                <p></p>
