   ...
   var category;
        ...
        $(function () {  
          ...
          $(".btn").on('click', function() {
              ...
              $.get( ip+"getdatosisp6", { "anho_1": anho_1, "week_1": week_1, "anho_2": anho_2, "week_2": week_2 } ).done(function( data) {
                      ...
                      $('#grafica5').highcharts({
                        ...
                        $("#btn1").empty();
                        $("#btn1").append("<button onclick='abrirVentana(8,183,category)' >Actualizar</button>");    

                        $("#btn2").empty();
                        $("#btn2").append("<button onclick='abrirVentana(8,184,category)' >Actualizar</button>");

                        $("#btn3").empty();
                        $("#btn3").append("<button onclick='abrirVentana(8,185,category)' >Actualizar </button>");

                        $("#btn4").empty();
                        $("#btn4").append("<button onclick='abrirVentana(8,186,category)' >Actualizar </button>");


                        $("#btn5").empty();
                        $("#btn5").append("<button onclick='abrirVentana(8,197,category)' >Actualizar </button>");
