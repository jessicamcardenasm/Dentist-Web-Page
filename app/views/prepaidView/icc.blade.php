   ...
   var category;
        ...
        $(function () {  
          ...
          $(".btn").on('click', function() {
              ...
              $.get( ip+"getdatosprepaid2", { "anho_1": anho_1, "week_1": week_1, "anho_2": anho_2, "week_2": week_2 } ).done(function( data) {
                      ...
                      $('#grafica6').highcharts({
                         ...
                         $("#btn1").empty();
                        $("#btn1").append("<button onclick='abrirVentana(6,102,category)' >Actualizar </button>");    

                        $("#btn2").empty();
                        $("#btn2").append("<button onclick='abrirVentana(6,103,category)' >Actualizar </button>");

                        $("#btn3").empty();
                        $("#btn3").append("<button onclick='abrirVentana(6,104,category)' >Actualizar </button>");

                        $("#btn4").empty();
                        $("#btn4").append("<button onclick='abrirVentana(6,105,category)' >Actualizar </button>");


                        $("#btn5").empty();
                        $("#btn5").append("<button onclick='abrirVentana(6,106,category)' >Actualizar </button>");

                        $("#btn6").empty();
                        $("#btn6").append("<button onclick='abrirVentana(6,107,category)' >Actualizar </button>");
