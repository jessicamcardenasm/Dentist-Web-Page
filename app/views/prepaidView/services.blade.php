   ...
   var category;
        ...
        $(function () {  
          ...
          $(".btn").on('click', function() {
              ...
              $.get( ip+"getdatosprepaid1", { "anho_1": anho_1, "week_1": week_1, "anho_2": anho_2, "week_2": week_2 } ).done(function( data) {
                     ...
                     $("#btn1").empty();
                        $("#btn1").append("<button onclick='abrirVentana(6,98,category)' >Actualizar </button>");    

                        $("#btn2").empty();
                        $("#btn2").append("<button onclick='abrirVentana(6,99,category)' >Actualizar </button>");

                        $("#btn3").empty();
                        $("#btn3").append("<button onclick='abrirVentana(6,100,category)' >Actualizar </button>");

                        $("#btn4").empty();
                        $("#btn4").append("<button onclick='abrirVentana(6,101,category)' >Actualizar </button>");
...
<!-- ////////////////////////// Select de año y semanas ////////////////////////////////////////-->
      ...
      <section class="wrapper">
          ...
          <section id="main-content">
               ...
               <section class="wrapper">
                <h3 > Cockpit Prepaid - Services / Session / Subscribers / TPS</h3>
                <p></p>
