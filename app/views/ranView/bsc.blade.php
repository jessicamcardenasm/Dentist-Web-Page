   ...
   var category;
        ...
        $(function () {  
          ...
          $(".btn").on('click', function() {
              ...
              $.get( ip+"getdatosran3", { "anho_1": anho_1, "week_1": week_1, "anho_2": anho_2, "week_2": week_2 } ).done(function( data) {
                     ...
                     $("#btn1").empty();
                        $("#btn1").append("<button onclick='abrirVentana(2,52,category)' >Actualizar </button>");    

                        $("#btn2").empty();
                        $("#btn2").append("<button onclick='abrirVentana(2,53,category)' >Actualizar </button>");

                        $("#btn3").empty();
                        $("#btn3").append("<button onclick='abrirVentana(2,54,category)' >Actualizar </button>");

                        $("#btn4").empty();
                        $("#btn4").append("<button onclick='abrirVentana(2,55,category)' >Actualizar </button>");
