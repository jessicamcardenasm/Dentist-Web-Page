   ...
   var category;
        ...
        $(function () {  
          ...
          $(".btn").on('click', function() {
              ...
              $.get( ip+"getdatosran2", { "anho_1": anho_1, "week_1": week_1, "anho_2": anho_2, "week_2": week_2 } ).done(function( data) {
                      ...
                      // ----------------CARGA DE DATA ------------------//
                       ...
                       for(var i = 0; i < num_elementos_g6; i++){
                        ...
                        var num_elementos_g7=data['g7']['elementos'].length;
                         ...
                         console.log(data['g7']['elementos']);
                         console.log(data['g7']['data']);
					...
					$('#grafica7').highcharts({
                         ...
                         $("#btn1").empty();
                        $("#btn1").append("<button onclick='abrirVentana(2,44,category)' >Actualizar </button>");    

                        $("#btn2").empty();
                        $("#btn2").append("<button onclick='abrirVentana(2,45,category)' >Actualizar </button>");

                        $("#btn3").empty();
                        $("#btn3").append("<button onclick='abrirVentana(2,46,category)' >Actualizar </button>");

                        $("#btn4").empty();
                        $("#btn4").append("<button onclick='abrirVentana(2,47,category)' >Actualizar </button>");


                        $("#btn5").empty();
                        $("#btn5").append("<button onclick='abrirVentana(2,48,category)' >Actualizar </button>");

                        $("#btn6").empty();
                        $("#btn6").append("<button onclick='abrirVentana(2,49,category)' >Actualizar</button>");

                        $("#btn7").empty();
                        $("#btn7").append("<button onclick='abrirVentana(2,50,category)' >Actualizar </button>");

                        $("#btn8").empty();
                        $("#btn8").append("<button onclick='abrirVentana(2,51,category)' >Actualizar </button>");
