    ...
    var category;
        ...
        $(function () {  
          ...
          $(".btn").on('click', function() {
              ...
              $.get( ip+"getdatosvas1", { "anho_1": anho_1, "week_1": week_1, "anho_2": anho_2, "week_2": week_2 } ).done(function( data) {

                        console.log(data["semanas"].length);

                        Data1=[

                        {data:[],name:'cohosted 1'},
                        ...
                        "cohosted 1": {"data":[],name:'cohosted 1'},
                        "cohosted 2": {"data":[],name:'cohosted 2'},
                        "SFE 1": {"data":[],name:'SFE 1'},
                        "SFE 2": {"data":[],name:'SFE 2'},
                        "OMU 2A": {"data":[],name:'OMU 2A'},
                        "OMU 2B": {"data":[],name:'OMU 2B'}
                        ...
                        //6 es el numero de elementos en la grafica g1
                        for (var j = 0; j < 6; j++) {
                        ...
                        for(var j = 0; j < 6; j++) {
                                for (var i = 0; i< data["g1"]["data"][0].length; i++) {
                                  ...
                                  switch(j){
                                    case 0:name1="cohosted 1"; break;
                                    case 1:name1="cohosted 2"; break;
                                    case 2:name1="SFE 1"; break;
                                    case 3:name1="SFE 2"; break;
                                    case 4:name1="OMU 2A"; break;
                                    case 5:name1="OMU 2B"; break;
                                  };
                        ...
                        for (var i = 0; i < data["semanas"].length; i++) {
                          ...
                          Data1[6]['data'].push(parseFloat(data['g1']['limite'][0]['limite']));
                          Data2[6]['data'].push(parseFloat(data['g2']['limite'][0]['limite']));
                          Data3[6]['data'].push(parseFloat(data['g3']['limite'][0]['limite']));
                          Data4[1]['data'].push(parseFloat(data['g4']['limite'][0]['limite']));
                        ...
                        $('#grafica').highcharts({
                          ...
                          $('#grafica2').highcharts({
                            ...
                            $("#btn1").empty();
                            $("#btn1").append("<button onclick='abrirVentana(5,82, category)' >Actualizar </button>");

                            $("#btn2").empty();
                            $("#btn2").append("<button onclick='abrirVentana(5,83, category)' >Actualizar</button>");

                            $("#btn3").empty();
                            $("#btn3").append("<button onclick='abrirVentana(5,84, category)' >Actualizar </button>");

                            $("#btn4").empty();
                            $("#btn4").append("<button onclick='abrirVentana(5,85, category)' >Actualizar </button>");
