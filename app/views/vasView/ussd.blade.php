...
<link rel="stylesheet" type="text/css" href="http://www.highcharts.com/highslide/highslide.css" />
    ...
    $(function () {  
          ...
          $(".btn").on('click', function(){
                ...
                $.get( ip+"getdatosvas2", { "anho_1": anho_1, "week_1": week_1, "anho_2": anho_2, "week_2": week_2 } ).done(function( data) {
                        ...
                        "UAS 1": {"data":[],name:'UAS 1'},
                        "UAS 2": {"data":[],name:'UAS 2'},
                        "USSD GW 1": {"data":[],name:'USSD GW 1'},
                        "USSD GW 2": {"data":[],name:'SFE 2'}
                        };
                        ...
                        for(var j = 0; j < 4; j++) {
                                for (var i = 0; i< data["g1"]["data"][0].length; i++) {
                                  ...
                                  switch(j){
                                    case 0:name1="UAS 1"; break;
                                    case 1:name1="UAS 2"; break;
                                    case 2:name1="USSD GW 1"; break;
                                    case 3:name1="USSD GW 2"; break;
                                  };
                        ...
                        for (var i = 0; i < data["semanas"].length; i++) {
                          ...
                          Data1[4]['data'].push(parseFloat(data['g1']['limite'][0]['limite']));
                          Data2[4]['data'].push(parseFloat(data['g2']['limite'][0]['limite']));
                          Data3[4]['data'].push(parseFloat(data['g3']['limite'][0]['limite']));
                        ...
                        var g4_nombre = data['g4']['nombre'][0]['nombre'];
                            ...
                            $("#btn1").empty();
                            $("#btn1").append("<button onclick='abrirVentana(5,86, category)' >Actualizar</button>");

                            $("#btn2").empty();
                            $("#btn2").append("<button onclick='abrirVentana(5,87, category)' >Actualizar</button>");

                            $("#btn3").empty();
                            $("#btn3").append("<button onclick='abrirVentana(5,88, category)' >Actualizar </button>");

                            $("#btn4").empty();
                            $("#btn4").append("<button onclick='abrirVentana(5,89, category)' >Actualizar </button>");
