   ...
   var category;
        ...
        $(function () {  
          ...
          $(".btn").on('click', function() {
              ...
              $.get( ip+"getdatosvoz5", { "anho_1": anho_1, "week_1": week_1, "anho_2": anho_2, "week_2": week_2 } ).done(function( data) {
                      ...
                      // ----------------CARGA DE DATA ------------------//
                       ...
                       for(var i = 0; i < num_elementos_g13; i++){
                        ...
                        var num_elementos_g14=data['g14']['elementos'].length;
                    
                  
                        for(var i = 0; i < num_elementos_g14; i++){

                        Data14[i]={};
                        Data14[i].data=[];  
                            for (var j = 0; j < data["g14"]["data"][0].length; j++) 

                                  {
                                     Data14[i]['data'].push(parseFloat(data['g14']['data'][i][j]['valor']));
                                     
                                  }  
                        Data14[i].name=data['g14']['elementos'][i]['nombre_elemento'];
                        } 

                        Data14[num_elementos_g14]={};
                        Data14[num_elementos_g14].data=[];
                        Data14[num_elementos_g14].name='Limit';   
                        Data14[num_elementos_g14].color='#FC1414'; 
                        Data14[num_elementos_g14].marker={radius: 0};
                       ...
                       for(var i = 0; i < num_elementos_g14; i++){
                        ...
                        var name=data['g14']['elementos'][i]['nombre_elemento'];
                        Comentario14[name]={};
                        Comentario14[name].data=[];
                            for (var j = 0; j < data["g14"]["data"][0].length; j++) 

                                  {
                                     Comentario14[name]['data'].push(data['g14']['data'][i][j]['comentario']);
                                     
                                  } 

                        Comentario14[name].name=data['g14']['elementos'][i]['nombre_elemento'];
                        ...
                        for (var i = 0; i < data["semanas"].length; i++) {
                          ...
                          Data14[num_elementos_g14]['data'].push(parseFloat(data['g14']['limite'][0]['limite']));
                        }
                        ...
                        var g14_nombre = data['g14']['nombre'][0]['nombre'];
					...
					$('#grafica7').highcharts({
						...
						$('#grafica14').highcharts({
                                                ...
                                                click: function (e) {
                                                    hs.htmlExpand(null, {
                                                        ...
                                                        maincontentText: 
                                                            ...
                                                            "<p> Serie "+ this.series.name + "</p> <p> Semana "+
                                                            this.category + "</p> <p>" +
                                                            Comentario14[this.series.name]['data'][this.x]+ "</p>",
                         ...
                         $("#btn1").empty();
                        $("#btn1").append("<button onclick='abrirVentana(1,141, category)' >Actualizar </button>");    

                        $("#btn2").empty();
                        $("#btn2").append("<button onclick='abrirVentana(1,142, category)' >Actualizar </button>");

                        $("#btn3").empty();
                        $("#btn3").append("<button onclick='abrirVentana(1,143, category)' >Actualizar </button>");

                        $("#btn4").empty();
                        $("#btn4").append("<button onclick='abrirVentana(1,144, category)' >Actualizar </button>");


                        $("#btn5").empty();
                        $("#btn5").append("<button onclick='abrirVentana(1,145, category)' >Actualizar </button>");

                        $("#btn6").empty();
                        $("#btn6").append("<button onclick='abrirVentana(1,146, category)' >Actualizar </button>");

                        $("#btn7").empty();
                        $("#btn7").append("<button onclick='abrirVentana(1,147, category)' >Actualizar </button>");

                        $("#btn8").empty();
                        $("#btn8").append("<button onclick='abrirVentana(1,148, category)' >Actualizar </button>");

                        $("#btn9").empty();
                        $("#btn9").append("<button onclick='abrirVentana(1,149, category)' >Actualizar </button>");


                        $("#btn10").empty();
                        $("#btn10").append("<button onclick='abrirVentana(1,150, category)' >Actualizar </button>");

                        $("#btn11").empty();
                        $("#btn11").append("<button onclick='abrirVentana(1,151, category)' >Actualizar </button>");

                        $("#btn12").empty();
                        $("#btn12").append("<button onclick='abrirVentana(1,152, category)' >Actualizar </button>");

                        $("#btn13").empty();
                        $("#btn13").append("<button onclick='abrirVentana(1,153, category)' >Actualizar </button>");

                        $("#btn14").empty();
                        $("#btn14").append("<button onclick='abrirVentana(1,154, category)' >Actualizar </button>");
