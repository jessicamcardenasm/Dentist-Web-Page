   ...
   var category;
        ...
        $(function () {  
          ...
          $(".btn").on('click', function() {
              ...
              $.get( ip+"getdatosvoz3", { "anho_1": anho_1, "week_1": week_1, "anho_2": anho_2, "week_2": week_2 } ).done(function( data) {
					...
					$('#grafica7').highcharts({
                         ...
                         $("#btn1").empty();
                        $("#btn1").append("<button onclick='abrirVentana(1,131, category)' >Actualizar </button>");    

                        $("#btn2").empty();
                        $("#btn2").append("<button onclick='abrirVentana(1,132, category)' >Actualizar </button>");

                        $("#btn3").empty();
                        $("#btn3").append("<button onclick='abrirVentana(1,133, category)' >Actualizar </button>");

                        $("#btn4").empty();
                        $("#btn4").append("<button onclick='abrirVentana(1,134, category)' >Actualizar </button>");


                        $("#btn5").empty();
                        $("#btn5").append("<button onclick='abrirVentana(1,135, category)' >Actualizar </button>");

                        $("#btn6").empty();
                        $("#btn6").append("<button onclick='abrirVentana(1,136, category)' >Actualizar </button>");

                        $("#btn7").empty();
                        $("#btn7").append("<button onclick='abrirVentana(1,137, category)' >Actualizar </button>");

                        $("#btn8").empty();
                        $("#btn8").append("<button onclick='abrirVentana(1,138, category)' >Actualizar </button>");
...
<!-- ////////////////////////// Select de año y semanas ////////////////////////////////////////-->
      ...
      <section class="wrapper">
          ...
          <section id="main-content">
               ...
               <section class="wrapper">
                <h3 > Cockpit VOZ - UMGS / LIMA MGW Pool</h3>
                <p></p>
